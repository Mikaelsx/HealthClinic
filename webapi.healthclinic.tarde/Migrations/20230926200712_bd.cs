        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Horario = table.Column<string>(type: "CHAR(14)", nullable: false),
                    NomeFantasia = table.Column<string>(type: "VARCHAR(80)", nullable: true),
                    RazaoSocial = table.Column<string>(type: "VARCHAR(300)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Feedback = table.Column<string>(type: "VARCHAR(50)", maxLength: 50, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TituloEspecialidade = table.Column<string>(type: "VARCHAR(50)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Medico_TiposUsuario_IdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataConsulta = table.Column<string>(type: "CHAR(14)", maxLength: 14, nullable: true),
                    HorarioConsulta = table.Column<string>(type: "VARCHAR(14)", maxLength: 14, nullable: true),
                    IdMedico = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdPaciente = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    IdComentario = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
